...
{
    $log = date('Y-m-d H:m:s') . ' ' . $_SERVER['REMOTE_ADDR'] . ' ' . $_SERVER['REMOTE_PORT'] . ' ' . $url . " <br />\n";
    $log = urldecode($log);
    ...
    <head>
        ...
        <style type="text/css">
            ...
            h1 {
                ...
                font-size: 19px;
                font-weight: normal;
            <?php if ($fontBeautify) { ?> font-family: 'Architects Daughter', 'Helvetica Neue', Helvetica, Arial, serif;
            <?php } ?> margin: 0 0 14px 0;
