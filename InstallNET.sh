...
# bash InstallNET.sh -dd 'https://oss.sunpma.com/Windows/Oracle_Win_Server2012R2_64_Administrator_nat.ee.gz'

# 内存为1G，所以推荐使用下面的win7企业版

# DD Windows7 sp1 64位 企业精简版 [账户Administrator密码nat.ee]
# bash InstallNET.sh -dd 'https://oss.sunpma.com/Windows/Oracle_Win7_sp1_64_Administrator_nat.ee.gz'
