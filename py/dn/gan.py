...
class DeepModel(torch.nn.Module):
    ...
    def initialize(self, opt):
        ...
        self.net_g = self.__define_g(opt.input_nc, opt.output_nc, opt.ngf, opt.net_g,
    ...
    def __define_g(self, input_nc, output_nc, ngf, net_g, n_downsample_global=3, n_blocks_global=9, n_local_enhancers=1,
